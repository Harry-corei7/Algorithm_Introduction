![image](https://github.com/user-attachments/assets/5a81d852-b702-45fc-a9ca-95f8375df35f)![image](https://github.com/user-attachments/assets/5a81d852-b702-45fc-a9ca-95f8375df35f)给定一个二叉树，判断它是否是`平衡二叉树`。

`平衡二叉树`是指该树所有节点的左右子树的高度相差不超过`1`。

1) 示例 1:

<image src = "https://github.com/user-attachments/assets/0e76961e-a619-4629-8ad9-797133c235a8" width = 330 height = 400> 
